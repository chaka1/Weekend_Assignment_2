...
public class MapsActivity extends FragmentActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener{
    ...
    private void addMarker(int current) {
            ...
            intent.putExtra(Constants.LOCATION_DATA_EXTRA, mRestaurantList.get(current).getPostcode());
    ...
    class AddressResultReceiver extends ResultReceiver {
        ...
        protected void onReceiveResult(int resultCode, Bundle resultData) {
           ...
           /* if (resultCode == Constants.SUCCESS_RESULT) {
            ...
            MarkerOptions marker = new MarkerOptions().position(new LatLng(Double.valueOf(address[2]), Double.valueOf(address[1]))).title(mRestaurantList.get(Integer.parseInt(address[0])).getName());
